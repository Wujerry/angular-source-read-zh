 ...
 *
 * # ng (core module)
 * ng module 是在AngularJS程序启动时默认加载的.ng module包含了AngularJS程序运行时所需要的一些基本组件.
 * 下面列出了一些高度抽象的组件/方法.
 * The table below
 ...
 * @kind function
 *
 * @description 转换string为小写.
 * @param {string} 待转换的string.
 * @returns {string} 转换后的string.
 */
//实际上就是调用的string.toLowerCase(),只是加上了参数是否为tring类型的判断
